...
Далее я начал изменять параметры .yalm файла ML-Agent
  ...
  ![image](https://user-images.githubusercontent.com/105949115/209600628-fafd1577-5956-4fb7-895b-b40a708676cb.png)
  
  Cumulative Reward, Extrinsic Reward и Policy Loss изменили свой вид и теперь оба возрастают
...
* ```ELO``` - Относительная мера натренированности игроков. При тренировке с помощью самостаятельной игры этот параметр должен постепенно увеличиваться.

## Выводы

В ходе работы я интегрировал экономическую систему в проект Unity и обученил ее с помощью ML-Agent. Ознакомился с документацией и поработал на практике с TensorBoard и ML-Agent. Ознакомился с реализацией экономической системы написанной на C# и используемой в Unity 
